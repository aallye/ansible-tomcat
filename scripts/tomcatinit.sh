...
export CATALINA_BASE=$work_folder/output/build
#TOMCAT_USER is the default user of tomcat
export TOMCAT_USER=anton
...
kill $pid
#nohup sh $CATALINA_HOME/bin/shutdown.sh
